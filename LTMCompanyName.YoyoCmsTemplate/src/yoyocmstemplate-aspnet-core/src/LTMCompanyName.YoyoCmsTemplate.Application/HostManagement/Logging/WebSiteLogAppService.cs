...
namespace LTMCompanyName.YoyoCmsTemplate.HostManagement.Logging
{
    public class WebSiteLogAppService : YoyoCmsTemplateAppServiceBase, IWebSiteLogAppService
    {
        ...
        public WebSiteLogAppService(IAppFolder appFolders)
        {
        ...
        {
            var tempDirectoryPath = Path.Combine(_appFolders.TempFileDownloadFolder,
                Guid.NewGuid().ToString("N").Substring(16));

...
import { EditionEditDto, ComboboxItemDto, EditionServiceProxy, CommonLookupServiceProxy, SubscribableEditionComboboxItemDto, CreateOrUpdateEditionDto } from '@shared/service-proxies/service-proxies';
...
export class CreateOrEditEditionComponent extends ModalComponentBase implements OnInit {

  @ViewChild('featureTree') featureTree: EditionFeatureTreeComponent;

...
import { SendTestEmailInput, TenantSettingsEditDto, TenantSettingsServiceProxy, DefaultTimezoneScope, ComboboxItemDtoTOfInt32, CommonLookupServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class TenantSettingsComponent extends AppComponentBase implements OnInit {
    ...
    defaultTimezoneScope: DefaultTimezoneScope = 1;

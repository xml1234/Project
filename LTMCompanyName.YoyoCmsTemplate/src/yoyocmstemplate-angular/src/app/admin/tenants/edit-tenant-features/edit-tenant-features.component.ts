...
import { TenantServiceProxy, EntityDto, UpdateTenantFeaturesInput } from '@shared/service-proxies/service-proxies';
...
export class EditTenantFeaturesComponent extends ModalComponentBase implements AfterViewInit {
